...
import { govService, type DemandHeatmapData } from '@/modules/analytics/analytics.service';
import { 
  Sparkles, 
  TrendingUp, 
  Users, 
    ...
    <div className="gov-page">
        ...
        <div>
          <div className="badge-row">
            ...
            <span className="pill-badge pill-blue">
              {data?.timeWindow || 'Illustrative dataset · demo only'}
            </span>
          </div>
      ...
      <div className="macro-kpi-grid">
        <div className="kpi-card glass-panel">
          ...
          <span className="kpi-label">Illustrative Footfall</span>
          <strong className="kpi-val">{data?.totalActiveTravellers.toLocaleString() || '14,820'}</strong>
          <span className="kpi-sub">Demo dataset · not current counts</span>
        </div>
      ...
      <div className="heatmap-card glass-panel">
        <div className="heatmap-head">
          <div>
            <span className="sub-label">ILLUSTRATIVE CAPACITY SCENARIO (FR-STAKE-01)</span>
